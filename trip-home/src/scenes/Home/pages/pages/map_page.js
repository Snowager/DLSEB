  ...
  if (location.state) {
    ...
    return (
      <>
        ...
        <MapContainer className="Map" package={props.package} lat={location.state.lat} lng={location.state.lng} city={location.state.cityName} status={map} type={location.state.type} zoom={13} id={1} state={location.state} activity_flag={location.state.flag}/>
      </>
    );
  }
  return (
